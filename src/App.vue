  ...
  <div id="app">
    <div class="container">
      <nav class="navbar navbar-dark bg-inverse navbar-fixed-top">
        <router-link to="/" class="navbar-brand text-success"> Icebear UI 组件</router-link>
        <ul class="nav navbar-nav">
          <li class="nav-item">
            <a href="https://icebear.me" target="_blank" class="nav-link"><i class="fa fa-home"></i> 主站</a>
          </li>
          <li class="nav-item">
    ...
    <div class="container" style="margin-top: 80px">
      <div class="row">
      <div class="col-xs-12 col-md-9 push-md-3 col-xl-9 push-xl-3">
          <router-view></router-view>
        </div>
        <div class="col-xs-12 col-md-3 pull-md-9 col-xl-3 pull-xl-9">
          <sidebar></sidebar>
        </div>
