function pageScroll() {
	$("#backtop").css("background-position-x", "-38px"), window.scrollBy(0, -20), scrolldelay = setTimeout("pageScroll()", 2), 0 == document.documentElement.scrollTop && 0 == document.body.scrollTop && ($("#backtop").css("background-position-x", "0"), clearTimeout(scrolldelay))
	$("#backtop-share").css("background-position-x", "-38px"), window.scrollBy(0, -20), scrolldelay = setTimeout("pageScroll()", 2), 0 == document.documentElement.scrollTop && 0 == document.body.scrollTop && ($("#backtop-share").css("background-position-x", "0"), clearTimeout(scrolldelay))
...
$(function() {
	$("#email,#password").blur(function() {
		...
		(document.documentElement.scrollTop || document.body.scrollTop) > 0 ? $("#backtop-share").show() : $("#backtop-share").hide()
	}), $("#backtop-share").click(function() {
		pageScroll()
